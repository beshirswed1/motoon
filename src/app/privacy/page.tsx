...
لممارسة أي من هذه الحقوق، تواصل معنا عبر: support@motoon.app`,
  },
  {
    icon: Shield,
...
يمكنك ضبط إعدادات ملفات تعريف الارتباط من متصفحك، مع ملاحظة أن بعض ميزات المنصة قد لا تعمل بشكل كامل.`,
  },
  {
    ...
    content: `منصة متون غير موجهة للأطفال دون سن 13 عاماً. لا نجمع عمداً بيانات شخصية من الأطفال دون هذا السن. إذا علمنا بأن طفلاً دون 13 سنة قد سجّل حساباً، سنحذف البيانات الفور.

للأعمار بين 13 و18 سنة، ننصح بمراجعة ولي الأمر لهذه السياسة.`,
  },
  {
    icon: Eye,
